...
alias kurulum='refl && codec plasma kinit dolphin dolphin-plugins xdg-user-dirs konsole kwrite vvave vlc ktorrent chromium opera opera-ffmpeg-codecs ufw kvantum-qt5 packagekit-qt5 iptables qemu virt-manager dnsmasq bridge-utils ovmf libvirt dmidecode xf86-video-amdgpu xf86-video-intel gwenview ark && sudo systemctl enable fstrim.timer && sudo systemctl enable sddm && usrmod && ayar && kllnc'
